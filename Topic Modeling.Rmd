...
Topic modeling is a method to find topics which are operationalized as bundles of correlating terms in documents to see what the texts are about. IMDB Dataset is chosen foranalysis. The dataset includes 50K movie reviews for natural language processing or text analytics. The topic modeling includes data cleaning procedures with utilization of tf-idf, and LDA to find out mixture of words in different topics or documents. Then terms within each topic are extracted and plotted to help understand the representation of these topics.
